...
$this->menu=array(
	array('label'=>'Employee','url'=>array('index'),'icon'=>'fa fa-list-alt', 'items' =>
		array(	
			...
			array('label'=>'Update Employee','url'=>array('update','id'=>$model->id),'icon'=>'fa fa-pencil','active'=>true),
			array('label'=>'View Employee','url'=>array('view','id'=>$model->id),'icon'=>'fa fa-eye'),
...
<?php $box = $this->beginWidget(
    ...
    array(
        'title' => 'Update Employees #'.$model->id,
