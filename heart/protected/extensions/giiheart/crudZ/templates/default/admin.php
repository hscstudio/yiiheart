...
$menu2=array(
	array('label'=>'<?php echo $this->modelClass; ?>','url'=>array('index',"pId"=>$pId),'icon'=>'fa fa-list-alt', 'items' =>
		array(	
			array('label'=>'List <?php echo $this->modelClass; ?>','url'=>array('index',"pId"=>$pId),'icon'=>'fa fa-list-ol','active'=>true),	
