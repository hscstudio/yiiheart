...
?>
<h1>CrudY Generator</h1>

<p>
CRUD ini menghasilkan operasi CRUD+ (Create, Read, Update, Delete, dan Export/Import). 
CRUD ini merupakan pasangan dari CrudZ
<br>
Default Layout : column1, kecuali action View (sebagai parent, dimana childnya adalah crudZ)
<br>
Requirement Extension : yiibooster, phpexcel via EExcelView and XPHPExcel 
<br>
</p>
