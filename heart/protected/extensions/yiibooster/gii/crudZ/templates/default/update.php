...
$menu2=array(
	array('label'=>'<?php echo $this->modelClass; ?>','url'=>array('index'),'icon'=>'fa fa-list-alt', 'items' =>
		array(	
			...
			array('label'=>'Create <?php echo $this->modelClass; ?>','url'=>array('create',"pId"=>$pId),'icon'=>'fa fa-plus-circle'),
			array('label'=>'Import <?php echo $this->modelClass; ?>','url'=>array('import',"pId"=>$pId),'icon'=>'fa fa-download'),
			array('label'=>'Update <?php echo $this->modelClass; ?>','url'=>array('update',"pId"=>$pId,'id'=>$model-><?php echo $this->tableSchema->primaryKey; ?>),'icon'=>'fa fa-pencil','active'=>true),
			array('label'=>'View <?php echo $this->modelClass; ?>','url'=>array('view',"pId"=>$pId,'id'=>$model-><?php echo $this->tableSchema->primaryKey; ?>),'icon'=>'fa fa-eye'),
