 ...
 *
 * The followings are the available columns in table 'ref_religion':
 * @property integer $id
...
class Religion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, status, createdBy, modifiedBy, deletedBy', 'numerical', 'integerOnly'=>true),
			...
			array('id, name, status, created, createdBy, modified, modifiedBy, deleted, deletedBy', 'safe', 'on'=>'search'),
		);
	}
